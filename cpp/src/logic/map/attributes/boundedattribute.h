#ifndef IMPDUNGEON_LOGIC_MAP_ATTRIBUTES_BOUNDEDATTRIBUTE_H_
#define IMPDUNGEON_LOGIC_MAP_ATTRIBUTES_BOUNDEDATTRIBUTE_H_
...
#endif  // IMPDUNGEON_LOGIC_MAP_ATTRIBUTES_BOUNDEDATTRIBUTE_H_
